...
readonly SCRIPT_COMMANDS=(shell create slot slots revoke profiles projects profile info help -h --help add remove install allowlist clean save project tmux kill lint)
...
get_command_requirements() {
    ...
    case "$cmd" in
        ...
        profiles|projects|help|-h|--help|slots|create|revoke|clean|import|unlink|kill|lint)
            echo "none"
            ;;
